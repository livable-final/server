...
public class RestaurantGroupByMenuProjectionRepository {
  ...
  private static final String FIND_RESTAURANT_BY_BUILDING_ID_QUERY;
  ...
  static {
	...
	FIND_RESTAURANT_BY_BUILDING_ID_QUERY = "SELECT res.id as restaurantId, res.name as restaurantName, res.thumbnail_image_url as restaurantThumbnailUrl, res.address as address, " +
		"brm.in_building as inBuilding, brm.distance as distance, " +
		"MAX(" +
		"(SELECT r.description " +
		"     FROM review r " +
